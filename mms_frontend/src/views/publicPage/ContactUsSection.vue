<template>
    <div class="bg-white py-10">
        <div class="flex justify-around">
            ...
            <div class="basis-2/5">
                <p class="border-y w-max">MAIL US</p>
                <p class="mt-4 text-4xl font-medium">Have a Question?</p>
                <div class="mt-8 grid grid-cols-2 gap-7">
                    <input class="border py-1 px-3" placeholder="Name" />
                    <input class="border py-1 px-3" placeholder="Email" />
                    <input class="border py-1 px-3" placeholder="Subject" />
                    <input class="border py-1 px-3" placeholder="Phone" />
                    <textarea style="resize:none;" class="col-span-2 border h-40 px-3 py-1" placeholder="Message"></textarea>
                    <button class="place-self-auto py-2 px-6 border border-green-400">Send</button>
                </div>
            </div>
        </div>
    </div>
