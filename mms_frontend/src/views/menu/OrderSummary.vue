    ...
    <div>
            <div class="shadow-lg p-3 w-full flex justify-between bg-white rounded-t-xl" >
                ...
                <div class="flex space-x-2">
                    ...
                    <svg @click="toggleModal" :class="[expand ? 'rotate-0':'rotate-180']" class="transition-transform ease-in-out duration-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M7.41 8.58L12 13.17l4.59-4.59L18 10l-6 6l-6-6l1.41-1.42Z"/></svg>
                </div>
            </div>
            <transition
...
export default {
    ...
    methods: {
        ...
        toggleModal(){
            console.log('Current expand state:', this.expand);
            this.expand = !this.expand;
            console.log('New expand state:', this.expand);
        }
    },
    created() {
        // this.loadCart();
