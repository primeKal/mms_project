        ...
        <div class="w-1/2 p-12 bg-white rounded-lg shadow shadow-white">
            ...
            <div class="w-full mt-5 flex justify-between">
                <div class="flex flex-col space-y-2">
                    <div class="flex">
                        <label class="w-1/5 text-black/70">Order No.:</label>
                        <p>{{ order.id }}</p>
                    </div>
                    <div class="flex">
                        <label class="w-1/5 text-black/70">Table No.:</label>
                        <p>{{ order.id }}</p>
                    </div>
                </div>
                <div class="flex flex-col space-y-2">
                    <div class="flex">
                        <label class="w-1/5 text-black/70">Order Total:</label>
                        <p>{{ $filter.formatPriceCurrency(order.totalPrice, 'ETB') }}</p>
                    </div>
                    <div class="flex">
                        <label class="w-1/5 text-black/70">Date:</label>
                        <p>{{ order.createdAt }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-5 flex justify-end">
                <button class="text-gray-400 mr-3">cancel</button>
