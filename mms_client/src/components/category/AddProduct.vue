<template>
  ...
  >
    ...
    >
      ...
      <button
        @click="toogleAdd(true)"
        class="mx-2 flex items-center text-black/70 hover:text-black"
      >
        <svg
          class="mr-2"
