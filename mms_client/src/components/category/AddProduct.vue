            ...
            <div class="ml-8 w-full flex flex-col space-y-2">
                ...
                <div class="flex justify-end">
                    <button @click="toogleAdd(false)"
                        class="py-1 px-4 text-gray-400 bg-slate-50 hover:bg-gray-100 active:scale-95 transition-all font-semibold rounded">cancel</button>
                    <button @click="createProduct(categoryId)"
                        class="ml-3 py-1 px-4 text-white bg-green-400 hover:bg-green-500 active:scale-95 transition-all font-semibold rounded">Save</button>
                </div>
            </div>
