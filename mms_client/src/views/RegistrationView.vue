    ...
    <div class="h-screen w-full flex flex-col justify-center items-center bg-white border-dark">
        <div class="w-1/3 p-5 flex flex-col bg-slate-100 rounded-lg shadow-lg">
            ...
            <div class="mt-5 flex flex-col">
                <input class="mt-3 py-2  pl-2 rounded border" placeholder="name" type="text"
                    v-model.trim="account.name" />

                <input class="mt-3 py-2  pl-2 rounded border" placeholder="username" type="text"
                    v-model.trim="account.username" />

                <input class="mt-3 py-2  pl-2 rounded border" placeholder="moto" type="text"
                    v-model.trim="account.moto" />

                <input class="mt-3 py-2 pl-2 rounded border" placeholder="Email" type="Email"
                    v-model.trim="account.email" />

                <input class="mt-3 py-2 pl-2 rounded border" placeholder="Password" type="password"
            ...
            <button @click="createAccount"
                ...
                <svg v-if="loading" class="self-center" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24">
