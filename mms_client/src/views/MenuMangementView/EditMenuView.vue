        ...
        <div class="lg:p-6 p-2 lg:pr-12 pr-2 w-full">
            <div class="flex lg:flex-row flex-col lg:justify-between">
                ...
                <div class="lg:mt-0 mt-4 flex lg:space-x-5 space-x-2 lg:text-base text-sm">
                    ...
                    <button @click="togglePublish" :disable="menuInformation.isActive" :class="[menuInformation.isActive ? 'text-gray-400 hover:bg-gray-400 border-gray-400 cursor-not-allowed' : 'text-primary hover:bg-primary border-primary']" class="px-3 py-1 flex items-center bg-transparent hover:text-white  rounded border active:scale-95 transition-all">
